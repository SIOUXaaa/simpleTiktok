...
type DouyinPublishListResponse struct {
	...
	StatusCode int32           `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" query:"status_code" form:"status_code" json:"status_code"`
	StatusMsg  string          `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" json:"status_msg,omitempty" form:"status_msg" query:"status_msg"`
	VideoList  []*common.Video `protobuf:"bytes,3,rep,name=video_list,json=videoList,proto3" json:"video_list,omitempty" form:"video_list" query:"video_list"` // list of videos posted by users
}
...
var file_publish_proto_rawDesc = []byte{
	...
	0x01, 0x0a, 0x0e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65,
	0x72, 0x12, 0x77, 0x0a, 0x0d, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x41, 0x63, 0x74, 0x69,
	...
	0x62, 0x6c, 0x69, 0x73, 0x68, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x2f, 0x42, 0x26, 0x5a, 0x24, 0x73,
	0x69, 0x6d, 0x70, 0x6c, 0x65, 0x54, 0x69, 0x6b, 0x74, 0x6f, 0x6b, 0x2f, 0x62, 0x69, 0x7a, 0x2f,
	0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x62, 0x61, 0x73, 0x69, 0x63, 0x2f, 0x70, 0x75, 0x62, 0x6c,
...
var file_publish_proto_depIdxs = []int32{
	...
	0, // 1: publish.PublishHandler.PublishAction:input_type -> publish.DouyinPublishActionRequest
	2, // 2: publish.PublishHandler.PublishList:input_type -> publish.DouyinPublishListRequest
	1, // 3: publish.PublishHandler.PublishAction:output_type -> publish.DouyinPublishActionResponse
	3, // 4: publish.PublishHandler.PublishList:output_type -> publish.DouyinPublishListResponse
