...
type DouyinRelationActionRequest struct {
	...
	ToUserId   int64  `protobuf:"varint,2,opt,name=to_user_id,json=toUserId,proto3" json:"to_user_id,omitempty" form:"to_user_id" query:"to_user_id"`
	ActionType int32  `protobuf:"varint,3,opt,name=action_type,json=actionType,proto3" json:"action_type,omitempty" form:"action_type" query:"action_type"` // 1-Follow, 2-Unfollow
}
...
type DouyinRelationFollowListResponse struct {
	...
	StatusCode int32          `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" query:"status_code" form:"status_code" json:"status_code"`
	StatusMsg  string         `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" json:"status_msg,omitempty" form:"status_msg" query:"status_msg"`
	UserList   []*common.User `protobuf:"bytes,3,rep,name=user_list,json=userList,proto3" json:"user_list,omitempty" form:"user_list" query:"user_list"` // User information list
}
...
type DouyinRelationFollowerListResponse struct {
	...
	StatusCode int32          `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" query:"status_code" form:"status_code" json:"status_code"`
	StatusMsg  string         `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" json:"status_msg,omitempty" form:"status_msg" query:"status_msg"`
	UserList   []*common.User `protobuf:"bytes,3,rep,name=user_list,json=userList,proto3" json:"user_list,omitempty" form:"user_list" query:"user_list"`
}
...
type DouyinRelationFriendListResponse struct {
	...
	StatusCode int32         `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" query:"status_code" form:"status_code" json:"status_code"`
	StatusMsg  string        `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" json:"status_msg,omitempty" form:"status_msg" query:"status_msg"`
	UserList   []*FriendUser `protobuf:"bytes,3,rep,name=user_list,json=userList,proto3" json:"user_list,omitempty" form:"user_list" query:"user_list"`
}
...
type FriendUser struct {
	...
	MsgType int64  `protobuf:"varint,3,opt,name=msgType,proto3" json:"msgType,omitempty" form:"msgType" query:"msgType"` // message type，0 - Messages currently requested by the user，1 - Messages sent by the current requesting user
}
...
var file_relation_proto_rawDesc = []byte{
	...
	0x6e, 0x2f, 0x66, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x2f, 0x42, 0x28,
	0x5a, 0x26, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x54, 0x69, 0x6b, 0x74, 0x6f, 0x6b, 0x2f, 0x62,
